...
function Footer() {
  return (
    <div>
      <footer
        className="relative w-full px-2x py-10 bg-fixed "
        style={{
      ...
      >
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-1 gap-8 px-5 py-3 lg:py-8 md:grid-cols-3 sm:grid-cols-2 lg:grid-cols-5">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li className="mb-4">Addis Ababa</li>
                <li className="mb-4">Ethiopia</li>
              </ul>
            </div>
            ...
            <div className="container mx-auto flex flex-col md:flex-row justify-between text-white ">
              <div className="sr-only md:not-sr-only flex flex-col grow lg:-my-10">
                <div className="flex mb-0 items-end select-none">
          ...
          <div className="px-1 py-0 bg-transparent md:flex md:items-center justify-between">
            
            <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">
              © 2023{" "}
              <a
                href="https://misikirzewedu.com/"
             ...
             <p className="max-w-sm text-sm  font-body text-gray-500 dark:text-gray-400 font-light">
