...
<footer  className='relative w-full px-20 py-20 bg-fixed '
        style={{
        ...
        <div>
         ...
         <div className="container mx-auto flex flex-col md:flex-row justify-between text-white ">
                <div className="sr-only md:not-sr-only flex flex-col grow lg:-my-10">
                    ...
                    <p className="max-w-sm text-sm  font-body text-gray-500 dark:text-gray-400 font-medium">
    ...
    <div className="px-4 py-6 bg-transparent md:flex md:items-center md:justify-between my-6">
        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="https://flowbite.com/" className='text-red-600 sr-only md:not-sr-only'>MisikrZewdu™</a>. All Rights Reserved.
        </span>
